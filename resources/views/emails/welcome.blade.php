                                          ...
                                          <tbody>
                                             <tr>
                                                <td align="center" style="padding: 56px 56px 28px 56px;" valign="top">
                                                   <a style="color: #3498DB; text-decoration: none;" href="https://www.getrevue.co/profile/brightonsmith?utm_campaign=Subscription+confirmation&amp;utm_content=profile-image&amp;utm_medium=email&amp;utm_source=confirmation" target="_blank"><img style="width: 56px; height: 56px; border: 0;" alt="Weekly newsletter of CyanVariable360 Studios" src="https://s3.amazonaws.com/revue/profiles/images/000/038/642/small/photo.png?1530276206">
                                                   </a>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                                                   <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong>Hi, {{$data['name']}}</strong>
                                                      Thank you for registering with OPTnation. You are seconds away to access thousands of Jobs listed on OPTnation. Please click the below link to verify your email.
                                                   </div>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td align="center" style="padding: 0 56px; padding-bottom: 56px;" valign="top">
                                                   <div>
                                                            ...
                                                            <a href=" {{ url('job-seeker/verify/'.$data['token'] . '/' . $data['email']) }}" style="background-color:#8ca930;border-radius:50px;color:#ffffff;display:inline-block;font-family: 'lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:18px;font-weight: bold;line-height:40px;text-align:center;text-decoration:none;width:270px;-webkit-text-size-adjust:none;" > verify Your Email</a>
                                                   ...
                                                   <script type="application/ld+json">
                                                      {
                                                        ...
                                                        "potentialAction": {
                                                          ...
                                                          "handler": {
                                                            ...
                                                            "url": "http://www.getrevue.co/profile/brightonsmith/subscribe?confirmation_token=WBZktO6LvA1--jrWp1S43A&amp;distinct_id=2793"
                                                          }
                                                        },
                                                        "description": "Confirm subscription to Weekly newsletter of CyanVariable360 Studios"
                                                      }
                                                   </script>
                                                </td>
                                             </tr>
