<header id="header">
			<div class="cp-burger-nav">
				<div id="cp_side-menu"> <a href="#" id="cp-close-btn" class="crose"><i class="fa fa-close"></i></a>
					...
					<strong class="logo-2"><a href="{{ url('/home') }}"><img src="../storage/app/photos/{{Auth::user()->photo}}" alt="img"></a></strong>
				...
				<div class="container">
					...
					<div class="user-option-col">
						<div class="thumb">
							<div class="dropdown">
								<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <img src="../storage/app/photos/{{Auth::user()->photo}}" width="50" height="50" alt="img"></button>
						...
						<div class="dropdown-box">
							<div class="dropdown">
								<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <img src="{{ asset('public/assets/images/option-icon.png') }}" alt="img"> </button>
