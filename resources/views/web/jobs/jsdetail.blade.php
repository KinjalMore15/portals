            ...
            <aside>
               <div class="sidebar">
                  <div class="box">
                     ...
                     <a data-toggle="modal" data-target="#loginModal" class="btn-apply">Apply This Job</a>                        
                     </div>
                  </div>
               ...
               <div class="box">
                  ...
                  <div class="text-col">
                     ...
                     <div class="clearfix">                         
                        ...
                        <a href="#"data-toggle="modal" data-target="#view-modal" class="applyJob btn-style-1 style-mid" id="edit-workexp">Apply for this Job Now</a> 
                  </div>
                  <div class="clearfix">
                     <h4>Overview</h4>
        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
             <div class="resum-form padd-tb">
                  <div class="row">
                     <div class="col-md-12">
                        <input name="certificate_degree_name" required="" type="text" placeholder="Certificate/Degree_name" value="">
                     </div>
                     <div class="col-md-12">
                        <input name="major" required="" type="text" placeholder="Major"  value="">
                     </div>
                     <div class="col-md-12">
                        <input name="institute_name" required="" type="text" placeholder="Institute Name" value="">
                     </div>
                     <div class="col-md-6">
                        <input class="unstyled" name="start_date" required="" type="date" placeholder="Start Date" value="">
                     </div>
                     <div class="col-md-6">
                        <input name="end_date" required="" type="date" placeholder="End Date" value="">
                     </div>
                     <div class="col-md-12">
